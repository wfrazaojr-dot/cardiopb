    ...
    <div className="space-y-6">
      <div className="bg-white border rounded-lg p-4 mb-4 shadow-sm">
        <div className="flex items-center justify-between gap-4 w-full">
          ...
          <img src="https://media.base44.com/images/public/68fa0edee56f5a67f929da76/9ba212c7d_LOGOCARDIOPB.jpg" alt="CARDIOPB" className="h-16 md:h-20 w-auto object-contain" />
      ...
      <div ref={relatorioRef} className="bg-white border-2 border-gray-300 rounded-lg p-4 shadow-lg" style={{ maxWidth: "210mm" }}>
        <div className="mb-4">
          <div className="flex items-center justify-between gap-3 w-full mb-3">
            ...
            <img src="https://media.base44.com/images/public/68fa0edee56f5a67f929da76/9ba212c7d_LOGOCARDIOPB.jpg" alt="CARDIOPB" className="h-12 w-auto object-contain" crossOrigin="anonymous" />
